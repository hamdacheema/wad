...
<head>
    ...
    <script>
        function funcofsearch(searchval) {
            var xmlhttp  = new XMLHttpRequest();
            xmlhttp.onreadystatechange = function() {
                if(this.readyState === 4 && this.status === 200){
                    document.getElementById("showPro").innerHTML = this.responseText;
                }
            }
            xmlhttp.open("GET","server/functions.php?sval=" + searchval);
            xmlhttp.send();
        }
    </script>
</head>
                    ...
                    <div class="col-lg-8 offset-lg-1 col-md-8 col-sm-7">
                        <form class="form-inline">
                            <div class="input-group">
                                ...
                                onkeyup="funcofsearch(this.value)">
